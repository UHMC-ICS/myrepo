...
var server = http.createServer(function(request, response) {
    ...
    switch (request.method) {
        case 'GET':
            ...
            } else if (mypath.search("mauibus/") > -1) {
                var datafile = "";
                var datatype = "application/json";

                switch (mypath) {
                    case "mauibus/wailukuloop/route1":
                        datafile = "mauibus/meo/WailukuLoopRoute1.json";
                        break;
                    case "mauibus/wailukuloop/route2":
                        datafile = "mauibus/meo/WailukuLoopRoute2.json";
                        break;
                    case "mauibus/all":
                        return replySuccess(response, "text/plain", "mauibus/meo/MauiBus.pdf");
                    default:
