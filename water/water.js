//-- saved from url=http://29a.ch/sandbox/2010/water/ 

var floor = Math.floor;
var canvas = null, ctx = null, width, height, size, buffer0, buffer1, aux, i, texture;
...
function init() {
    ...
    loadImage("background.jpg", function(img) {
