...
var Element = function(entry) {
	...
	dom.addEventListener('click', function(event) {
		...
		player.src = '//www.youtube.com/embed/' + entry.id.$t.split(':').pop() + '?rel=0&autoplay=1&controls=1&showinfo=0';
...
function search(query) {
	...
	request.open('GET', '//gdata.youtube.com/feeds/api/videos?v=2&alt=json&max-results=50&q=' + query, true);
	request.send(null);
